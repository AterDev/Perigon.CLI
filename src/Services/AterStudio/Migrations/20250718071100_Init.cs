...
public partial class Init : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                Id = table.Column<Guid>(type: "TEXT", nullable: false),
                Name = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                OutputContent = table.Column<string>(
                    type: "TEXT",
                    maxLength: 100000,
                    nullable: true
                ),
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_ModelInfo_Projects_ProjectId",
                    column: x => x.ProjectId,
                    principalTable: "Projects",
                    principalColumn: "Id",
                    onDelete: ReferentialAction.Cascade
        ...
        migrationBuilder.CreateIndex(name: "IX_ModelInfo_Name", table: "ModelInfo", column: "Name");
    ...
    {
        migrationBuilder.DropTable(name: "ApiDocInfos");

        migrationBuilder.DropTable(name: "Configs");

        migrationBuilder.DropTable(name: "GenActionGenSteps");

        migrationBuilder.DropTable(name: "ModelProperties");

        migrationBuilder.DropTable(name: "GenActions");

        migrationBuilder.DropTable(name: "GenSteps");
